...
const objectSizeUIImageQuery = graphql`
  query ObjectSizeUIImageQuery {
    image: file(relativePath: {eq: "images/ridipaper4/features/size-ui.png"}) {
      childImageSharp {
...
export const ObjectSizeUI = (): JSX.Element => {
  const objectSizeUIImage = useStaticQuery<ImageQueryResponse>(objectSizeUIImageQuery);
