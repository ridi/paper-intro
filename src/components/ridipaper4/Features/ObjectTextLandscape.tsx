...
const TEXT_COLUMNS = (() => {
  const maxLines = Math.floor(2 * constants.BASE_HEIGHT / (FONT_SIZE * LINE_HEIGHT));
  const lines = chunkTextByWidth(constants.PREVIEW_TEXT, FONT_SIZE, constants.BASE_WIDTH, maxLines);
